        ...
        <>
            ...
            <div className='col-12 mt-5'>
                ...
                <form>
                    ...
                    <div className='form-group'>
                        <label>Upload da Foto {props.match.params.id ? '(Caso queira manter a mesma foto, não precisa escolher nova imagem)' : null} </label>
                        <input onChange={(e) => setFotoNova(e.target.files[0])} type='file' className='form-control' />
                    </div>

                    {
                        carregando ? <Loader />
                            : <button onClick={props.match.params.id ? atualizar : cadastrar} type='button' className='btn btn-lg btn-block mt-3 mb-5 btn-publicar'>
